...
--
-- Table structure for table `merch_purchase`
--
...
--
-- Dumping data for table `merch_purchase`
--
...
CREATE TABLE `user` (
  ...
  `merch_purchased` int(11) NOT NULL DEFAULT 0,
  `ticket_purchased` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`user_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-04-22 20:15:29
